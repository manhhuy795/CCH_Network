...
CASES = (
    {
        ...
        "label": "Dự án 2 (VLAN 93) · HQ -> Branch",
        "source": "h93_01",
        "destination": "h93_11",
        "expected": True,
        "evidence": "MPLS L2VPN Primary forward path (VLAN 93)",
    },
    {
        "id": "vlan93_branch_to_hq",
        "label": "Dự án 2 (VLAN 93) · Branch -> HQ",
        "source": "h93_11",
        "destination": "h93_01",
        "expected": True,
        "evidence": "MPLS L2VPN Primary return path (VLAN 93)",
    },
    {
        "id": "project_segmentation",
        "label": "Dự án 1 !-> Dự án 3 (Cô lập)",
        "source": "h101_01",
        "destination": "h103_01",
        "expected": False,
        "evidence": "Inter-project SDN isolation (Table 20)",
    },
    {
        "id": "partner_pbx",
        "label": "Dự án 1 -> Tổng đài PBX (Voice)",
        "source": "h101_01",
        "destination": "h90",
        "expected": True,
    ...
    },
    {
        ...
        "label": "Branch IoT -> Giám sát NMS (HQ)",
    ...
    {
        "id": "guest_isolation",
        "label": "Khách vãng lai !-> Dự án 2 (Cô lập)",
        "source": "guest_01",
        "destination": "h93_01",
        "expected": False,
