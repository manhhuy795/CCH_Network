...
Note: `fw_hq` va `fw_telesale` trong dashboard la **Internet Edge Boundary** mo phong bang Linux router namespace, khong phai stateful firewall thiet bi neu chua cau hinh nftables/iptables/conntrack that.
