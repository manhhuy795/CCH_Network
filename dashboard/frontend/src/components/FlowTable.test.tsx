...
const flows = [
  ...
  { switch: "dist_branch", cookie: "0x1200", priority: 425, match: "h50_01 → h90", action: "ALLOW", packets: 15, bytes: 2400, source: "h50_01", destination: "h90", reason: "Cho phép Voice", raw_match: "ip,nw_dst=172.10.90.10", raw_action: "output:2" },
];
