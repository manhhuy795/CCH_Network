...
POLICY_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "isolate_telesale_backoffice": {
        ...
        "action": "DROP",
        "enforcement_point": "dist_branch / core_hq theo chieu nguon",
        "priority": 400,
        "cookie": "0x1002",
    },
    "isolate_hq_users_from_telesale": {
        "name": "Cach ly nguoi dung HQ voi Telesale",
        "description": "Khong cho phep luu luong ngang khong duoc cap quyen giua hai site.",
        "source": "VLAN HQ / VLAN 50",
        "destination": "Site doi dien",
        "action": "DROP",
        "enforcement_point": "core_hq",
        "priority": 400,
        "cookie": "0x1003",
    ...
    payload["enforcement_layers"] = {
        "openflow": {
            ...
            "responsibilities": [
                ...
                "Chặn Telesale → BackOffice tại dist_branch",
